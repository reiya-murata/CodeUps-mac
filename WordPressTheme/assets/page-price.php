            ...
            <tbody>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  オープンウォーター<br class="pc-hidden">ダイバーコース
                </td>
                <td class="price-page-table__price">¥50,000</td>
              </tr>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  アドバンスド<br class="pc-hidden">オープンウォーターコース
                </td>
                <td class="price-page-table__price">¥60,000</td>
              </tr>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">レスキュー＋EFRコース</td>
                <td class="price-page-table__price">¥70,000</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div class="price-page-content">
          <table class="price-page-table">
            ...
            <tbody>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ビーチ体験ダイビング<br class="pc-hidden"> (半日)
                </td>
                <td class="price-page-table__price">¥7,000</td>
              </tr>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ビーチ体験ダイビング<br class="pc-hidden"> (1日)
                </td>
                <td class="price-page-table__price">¥14,000
                </td>
              </tr>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ボート体験ダイビング <br class="pc-hidden">(半日)
                </td>
                <td class="price-page-table__price">¥10,000</td>
              </tr>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ボート体験ダイビング<br class="pc-hidden"> (1日)
                </td>
                <td class="price-page-table__price">¥18,000</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="price-page-content">
          <table class="price-page-table">
            ...
            <tbody>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ビーチダイビング <br class="pc-hidden">(2ダイブ)
                </td>
                <td class="price-page-table__price">¥14,000</td>
              </tr>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ボートダイビング<br class="pc-hidden">(2ダイブ)
                </td>
              ...
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  スペシャルダイビング<br class="pc-hidden">(2ダイブ)
                </td>
                <td class="price-page-table__price">
                  ¥24,000
                </td>
        ...
        <div class="price-page-content">
          <table class="price-page-table">
            ...
            <tbody>
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  貸切ダイビング<br class="pc-hidden">(2ダイブ)
                </td>
                <td class="price-page-table__price">
                  ¥24,000
                </td>
              ...
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  1日ダイビング<br class="pc-hidden">(3ダイブ)
                </td>
                <td class="price-page-table__price">
                  ¥32,000
                </td>
              ...
              <tr class="price-page-table__row">
                <td class="price-page-table__name">
                  ナイトダイビング<br class="pc-hidden">(2ダイブ)
                </td>
                <td class="price-page-table__price">
                  ¥14,000
                </td>
